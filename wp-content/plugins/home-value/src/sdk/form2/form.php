...
namespace plainview\sdk_eightb_home_value\form2;
...
/**
	...
	@code
		$form = new \\plainview\\sdk_eightb_home_value\\form2\\form();
		// Add a text input
		$form->text( 'username' )
			->label( 'Your username' );
	...
	**/
	...
	public function __construct()
	{
		...
		foreach( $input_types as $input_type )
		{
			$o = new \stdClass();
			$o->name = $input_type;
			$o->class = '\\plainview\\sdk_eightb_home_value\\form2\\inputs\\' . $input_type;
			$this->register_input_type( $o );
		}

		// action may not be empty
		$this->set_attribute( 'action', \plainview\sdk_eightb_home_value\base::current_url() );
