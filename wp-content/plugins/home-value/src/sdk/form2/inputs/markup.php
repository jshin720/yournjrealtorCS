	...
	extends input
{
	...
	**/
	public function _construct()
	{
		if ( $this->get_attribute( 'name' ) == '' )
			$this->set_attribute( 'name', \plainview\sdk_eightb_home_value\base::uuid( 4 ) );
	}

	public function __toString()
	{
		return \plainview\sdk_eightb_home_value\form2\form::unfilter_text( $this->get_value() );
	}
	...
	**/
	...
	{
		return $this->markup( \plainview\sdk_eightb_home_value\base::wpautop( $markup ) );
	}
