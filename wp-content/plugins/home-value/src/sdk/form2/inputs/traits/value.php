...
/**
	...
	If you wish to retrieve the value, run a \plainview\sdk_eightb_home_value\form2\form::unfilter_text() on it to return it to its original status.
...
trait value
{
	...
	**/
	public function get_filtered_post_value()
	{
		...
		return \plainview\sdk_eightb_home_value\form2\form::filter_text( $value );
	}
	...
	**/
	...
	{
		$value = $this->apply_value_filters( $value );
		$value = \plainview\sdk_eightb_home_value\form2\form::filter_text( $value );
