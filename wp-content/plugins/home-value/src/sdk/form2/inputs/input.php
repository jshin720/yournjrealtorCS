...
class input
{
	...
	use \plainview\sdk_eightb_home_value\html\indentation;
	...
	**/
	...
	{
		$random = \plainview\sdk_eightb_home_value\base::uuid();
	...
	**/
	public function display_input()
	{
		...
		if ( $input->form()->post_is_set() )
		{
			...
			if ( $value != '' )
			{
				$value = \plainview\sdk_eightb_home_value\form2\form::unfilter_text( $value );
				$input->value( $value );
			}
			else
	...
	**/
	...
	{
		$r = new \plainview\sdk_eightb_home_value\html\div();
	...
	**/
	public function make_id()
	{
		if ( $this->has_attribute( 'id' ) )
			return $this->get_attribute( 'id' );
		$id = $this->make_name();
		$id = \plainview\sdk_eightb_home_value\base::strtolower( $id );
	...
	**/
	...
	{
		$title = \plainview\sdk_eightb_home_value\form2\form::filter_text( $title );
