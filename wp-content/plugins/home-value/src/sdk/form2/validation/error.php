...
namespace plainview\sdk_eightb_home_value\form2\validation;
...
class error
{
	use \plainview\sdk_eightb_home_value\form2\inputs\traits\label;
	...
	**/
	...
	public function __construct( $input )
	{
		...
		$this->label = new \plainview\sdk_eightb_home_value\form2\inputs\label( $input );
	}
