...
namespace plainview\sdk_eightb_home_value\pagination;

use \plainview\sdk_eightb_home_value\base;
use \plainview\sdk_eightb_home_value\html\div;
...
/**
	...
	$p = new \plainview\sdk_eightb_home_value\pagination\pagination;
	$p->page( 77 )
		->pages( 186 )
