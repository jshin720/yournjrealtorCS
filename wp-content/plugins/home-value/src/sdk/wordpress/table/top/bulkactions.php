...
namespace plainview\sdk_eightb_home_value\wordpress\table\top;

use \plainview\sdk_eightb_home_value\collections\collection;
...
class bulkactions
{
	...
	**/
	public function cb( $row, $id = null )
	{
		...
		if ( $section == 'plainview\\sdk_eightb_home_value\\table\\head' )
		{
		...
		if ( $section == 'plainview\\sdk_eightb_home_value\\table\\body' )
		{
