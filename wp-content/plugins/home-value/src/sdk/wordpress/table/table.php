...
namespace plainview\sdk_eightb_home_value\wordpress\table;
...
**/
class table
	extends \plainview\sdk_eightb_home_value\table\table
{
	use \plainview\sdk_eightb_home_value\traits\method_chaining;

	/**
		@brief		The \\plainview\\sdk_eightb_home_value\\table\\wordpress\\base object that created this class.
	**/
	public $base;
