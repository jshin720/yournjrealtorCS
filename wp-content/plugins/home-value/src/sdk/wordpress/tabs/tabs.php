...
namespace plainview\sdk_eightb_home_value\wordpress\tabs;
...
{
	use \plainview\sdk_eightb_home_value\traits\method_chaining;
	use \plainview\sdk_eightb_home_value\html\element;

	/**
		@brief		\\plainview\\sdk_eightb_home_value\\wordpress\\base object that created these tabs.
		@since		20130503
		@var		$base
	**/
	public $base;
	...
	**/
	...
	/**
		@brief		Collection of \\plainview\\sdk_eightb_home_value\\wordpress\\tabs\\tab objects.
		@since		20130503
		@var		$tabs
	**/
	public $tabs;
	...
	**/
	...
	{
		$this->base = $base;
		$this->tabs = new \plainview\sdk_eightb_home_value\collections\Collection();
		$this->_construct();
	}
