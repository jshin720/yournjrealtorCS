...
namespace plainview\sdk_eightb_home_value\wordpress\traits;

/**
	@brief			Wordpress-specific db_aware_object.
	@details		Uses \plainview\sdk_eightb_home_value\db_aware_object.
	@version		20130430
**/
trait db_aware_object
{
	use \plainview\sdk_eightb_home_value\traits\db_aware_object;
