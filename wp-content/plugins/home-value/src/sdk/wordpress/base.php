<?php
namespace plainview\sdk_eightb_home_value\wordpress;
...
/**
    ...
    @copyright	GPL v3
**/
class base extends \plainview\sdk_eightb_home_value\base
{
    ...
    **/
    public function __construct($__FILE__ = null)
    {
        ...
        $this->submenu_pages = new \plainview\sdk_eightb_home_value\collections\collection;
        ...
        if ($form->is_posting()) {
            ...
            if ($form->input('uninstall')->pressed()) {
                if ($form->input('sure')->get_post_value() != 'on') {
                    ...
                    $this->message_(
                        'The plugin and all associated settings and database tables have been removed. Please %sfollow this link to complete the uninstallation procedure%s.',
    ...
    */
    public function _($string)
    {
        ...
        return $translated = __($string, $this->language_domain);
        //return $translated;
    }
    ...
    **/
    public function cli_pot()
    {
        ...
        $command = sprintf(
            'xgettext -s -c --no-wrap -d %s -p lang -o "%s" --omit-header%s %s',
            get_class($this),
            $pot,
    ...
    **/
    ...
    {
        $form = new \plainview\sdk_eightb_home_value\wordpress\form2\form($this);
        return $form;
    }

    /**
        @brief		Backwards compatibility alias for form.
        @return		\\plainview\\sdk_eightb_home_value\\form2\\form		A new form object.
        @since		20130509
    **/
    ...
    **/
    ...
    {
        $tabs = new \plainview\sdk_eightb_home_value\wordpress\tabs\Nav_Tabs($this);
        return $tabs;
    }
    ...
    **/
    ...
    {
        $tabs = new \plainview\sdk_eightb_home_value\wordpress\tabs\Subsubsub_Tabs($this);
        return $tabs;
    }
    ...
    **/
    ...
    /**
        ...
        @return		object		A new \\plainview\\sdk_eightb_home_value\\wordpress\\table object.
        @since		20130416
    **/
    public function table()
    {
        $table = new \plainview\sdk_eightb_home_value\wordpress\table\table($this);
