...
namespace plainview\sdk_eightb_home_value\wordpress\plugin_pack;
...
**/
class plugin
	extends \plainview\sdk_eightb_home_value\collections\collection
{
	/**
		@brief		Constructor.
	...
	**/
	public function load()
	{
		...
		if ( $reflection->isSubClassOf( '\\plainview\\sdk_eightb_home_value\\wordpress\\base' ) )
