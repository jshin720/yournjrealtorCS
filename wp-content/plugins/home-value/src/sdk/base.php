...
namespace plainview\sdk_eightb_home_value;
...
class base
{
	...
	**/
	...
	{
		if ( ! class_exists( '\\plainview\\sdk_eightb_home_value\\form2\\form' ) )
			require_once( dirname( __FILE__ ) . '/form2/form.php' );

		if ( ! class_exists( '\\plainview\\sdk_eightb_home_value\\wordpress\\form2\\form' ) )
			require_once( 'form2.php' );

		$form = new \plainview\sdk_eightb_home_value\wordpress\form2\form();
		return $form;
	}
	...
	**/
	...
	/**
		...
		@return		\\plainview\\sdk_eightb_home_value\\mail\\mail		A new PHPmailer object.
		@since		20130430
	**/
	public static function mail()
	{
		$mail = new \plainview\sdk_eightb_home_value\mail\mail();
		$mail->CharSet = 'UTF-8';
		return $mail;
	}
