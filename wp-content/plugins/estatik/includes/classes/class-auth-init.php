...
class Es_Auth {
	...
	public static function register() {
		if ( wp_verify_nonce( es_get_nonce( 'es_register_nonce' ), 'es_register' ) ) {
	...
	public static function login() {
		if ( wp_verify_nonce( es_get_nonce( 'es_auth_nonce' ), 'es_authenticate' ) ) {
			$credentials = array(
				'user_login' => es_clean( filter_input( INPUT_POST, 'es_user_login' ) ),
				'user_password' => filter_input( INPUT_POST, 'es_user_password' ),
				'remember' => true,
	...
	public static function retrieve_password() {
		if ( wp_verify_nonce( es_get_nonce( 'es_retrieve_pwd_nonce' ), 'es_retrieve_pwd' ) ) {
			$email = es_clean( filter_input( INPUT_POST, 'es_user_email' ) );
			$is_popup = es_clean( filter_input( INPUT_POST, 'is_popup' ) );
	...
	public static function reset_password() {
		if ( wp_verify_nonce( es_get_nonce( 'es_reset_pwd_nonce' ), 'es_reset_pwd' ) ) {
